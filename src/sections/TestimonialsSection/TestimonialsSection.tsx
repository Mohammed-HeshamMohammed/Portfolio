...
export const TestimonialsSection = (): JSX.Element => {
  ...
  return (
    <section className="flex flex-col items-center gap-8 sm:gap-12 px-4 sm:px-8 lg:px-[71px] py-[60px] sm:py-[97px] w-full max-w-[1440px] mx-auto">
      <header className="flex w-full max-w-[1298px] items-center justify-between flex-col sm:flex-row gap-4 sm:gap-0">
        <h2 className="[font-family:'Lufga-Bold',Helvetica] font-bold text-[#344053] text-2xl sm:text-4xl lg:text-5xl tracking-[-0.72px] leading-[1.2] text-center sm:text-left max-w-[300px] sm:max-w-none">
          From my
          <br />
          blog post
        </h2>

        <Button className="h-auto bg-[#f72585] hover:bg-[#7209b7] transition-all duration-300 rounded-[30px] sm:rounded-[45px] lg:rounded-[60px] px-6 sm:px-8 lg:px-10 py-3 sm:py-4 lg:py-5">
