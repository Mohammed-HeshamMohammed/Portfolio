...
export const ContactSection = (): JSX.Element => {
  return (
    <section id="contact" className="flex flex-col items-start justify-between px-4 sm:px-8 lg:px-[71px] py-[25px] relative w-full bg-[#272727] rounded-[15px_15px_0px_0px] sm:rounded-[20px_20px_0px_0px] lg:rounded-[24px_24px_0px_0px]">
      <header className="flex items-center justify-between relative w-full flex-col sm:flex-row gap-4 sm:gap-0 mb-8">
        <h1 className="relative flex items-center justify-center w-full sm:w-[643px] h-auto mt-[-1.00px] [font-family:'Lufga-SemiBold',Helvetica] font-semibold text-[#fbfcfc] text-[28px] sm:text-[48px] lg:text-[64px] tracking-[-0.96px] leading-[normal] text-center sm:text-left">
          Lets Connect there
        </h1>

        <Button 
          className="flex w-full sm:w-[202px] items-center justify-center px-5 py-2.5 relative bg-[#f72585] rounded-[30px] sm:rounded-[45px] lg:rounded-[60px] h-auto hover:bg-[#f72585]/90"
          onClick={() => {
      ...
      <Separator className="relative w-full h-0.5 ml-[-1.00px] mr-[-1.00px] bg-white/20 mb-8" />

      <main className="flex items-start justify-between relative w-full flex-col lg:flex-row gap-8 lg:gap-0 mb-8">
        <div className="inline-flex flex-col items-start justify-between relative w-full lg:w-auto gap-4 lg:gap-6">
          <div className="w-full sm:w-[307px] h-auto sm:h-[86px] px-0 py-5 relative rounded-[30px] sm:rounded-[45px] lg:rounded-[60px] flex items-center gap-2.5 justify-center sm:justify-start">
          ...
          <div className="inline-flex items-start gap-[5px] relative justify-center lg:justify-start">
        ...
        <nav className="items-start gap-4 sm:gap-7 relative inline-flex flex-col text-center lg:text-left">
          ...
          <ul className="inline-flex flex-col items-center lg:items-start gap-3 sm:gap-5 relative">
        ...
        <div className="items-start gap-4 sm:gap-7 relative inline-flex flex-col text-center lg:text-left">
          ...
          <div className="inline-flex flex-col items-center lg:items-start gap-3 sm:gap-5 relative">
        ...
        <div className="items-start gap-4 sm:gap-7 relative inline-flex flex-col text-center lg:text-left">
          ...
          <div className="flex w-full max-w-[304px] items-start relative">
            <Input
              placeholder="Email Address"
              className="flex flex-1 h-[40px] sm:h-[51px] items-center gap-2.5 px-3.5 py-[10px] sm:py-[13px] relative bg-white rounded-[10px_0px_0px_10px] sm:rounded-[14px_0px_0px_14px] border-0 [font-family:'Lufga-Regular',Helvetica] font-normal text-black text-sm sm:text-base tracking-[-0.24px] leading-[normal] focus-visible:ring-0"
            />

            <Button className="flex w-[40px] sm:w-[46px] h-[40px] sm:h-[51px] items-center justify-center gap-2.5 px-2 py-2.5 relative bg-[#f72585] rounded-[0px_10px_10px_0px] sm:rounded-[0px_14px_14px_0px] hover:bg-[#f72585]/90">
      ...
      <Separator className="relative w-full h-0.5 ml-[-1.00px] mr-[-1.00px] bg-white/20 mb-6" />

      <footer className="flex items-start justify-between relative w-full flex-col sm:flex-row gap-4 sm:gap-0 text-center sm:text-left">
