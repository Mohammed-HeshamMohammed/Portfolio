...
// Define the Intl.Segmenter interface for TypeScript
interface IntlSegmenter {
  segment(text: string): Iterable<{ segment: string; index: number; input: string }>;
}
...
declare global {
  namespace Intl {
    const Segmenter: IntlSegmenterConstructor | undefined;
  }
}
